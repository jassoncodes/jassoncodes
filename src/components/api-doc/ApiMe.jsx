...
export const ApiMe = () =>
{
    ...
    return (
        <Container className="p-2">
            ...
            <Row>
                <Col>
                    <p>This endpoint gets all the information rendered in my <Link className="text-decoration-none fw-bold text-dark" to={'/live-resume'}>live resume</Link> including, experience, studies, projects and contact information.</p>
